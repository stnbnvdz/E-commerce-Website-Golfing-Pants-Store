    ...
    function electro_home_v5_product_tabs_carousel() {
        if ( is_woocommerce_activated() ) {
            ...
            $args = apply_filters( 'electro_home_v5_product_tabs_carousel_args', array(
                ...
                'carousel_args' => array(
                    'items'         => isset( $home_v5['ptc']['carousel_args']['product_columns'] ) ? intval( $home_v5['ptc']['carousel_args']['product_columns'] ) : 6,
    ...
    function electro_home_v5_products_carousel() {
        if ( is_woocommerce_activated() ) {
            ...
            $args = apply_filters( 'electro_home_5_products_carousel_args', array(
                ...
                'carousel_args' => array(
                    'items'             => isset( $pc_options['carousel_args']['dots'] ) ? filter_var( $pc_options['carousel_args']['dots'], FILTER_VALIDATE_BOOLEAN ) : 6,
                ...
                'columns'   => isset( $home_v5['pc']['product_columns'] ) ? $home_v5['pc']['product_columns'] : 6,
            ) );
    ...
    function electro_home_v5_product_carousel_v5_1() {
        ...
        if ( is_woocommerce_activated() ) {
            ...
            $args = apply_filters( 'electro_home_v5_product_carousel_v5_1_args', array(
                ...
                'carousel_args' => array(
                    'items'             => isset( $pc1_options['carousel_args']['dots'] ) ? filter_var( $pc1_options['carousel_args']['dots'], FILTER_VALIDATE_BOOLEAN ) : 7,
    ...
    function electro_home_v5_product_carousel_v5_2() {
        ...
        if ( is_woocommerce_activated() ) {
            ...
            $args = apply_filters( 'electro_home_v5_product_carousel_v5_1_args', array(
                ...
                'carousel_args' => array(
                    'items'             => isset( $pc2_options['carousel_args']['dots'] ) ? filter_var( $pc2_options['carousel_args']['dots'], FILTER_VALIDATE_BOOLEAN ) : 7,
