...
if ( ! function_exists( 'electro_home_v4_slider_with_ads_block' ) ) {
    ...
    function electro_home_v4_slider_with_ads_block() {
        ...
        $args = apply_filters( 'electro_home_v4_slider_with_ads_block_args', array(
            ...
            'ads_args'          => array(
                array(
                    'ad_text'       => isset( $home_v4['swa']['ads_args'][0]['ad_text'] ) ? $home_v4['swa']['ads_args'][0]['ad_text'] : wp_kses_post( __( 'Catch Big <strong>Deals</strong> on the Cameras', 'electro' ) ),
                ...
                array(
                    'ad_text'       => isset( $home_v4['swa']['ads_args'][1]['ad_text'] ) ? $home_v4['swa']['ads_args'][1]['ad_text'] : wp_kses_post( __( 'Shop the <strong>Hottest</strong> Products', 'electro' ) ),
                ...
                array(
                    'ad_text'       => isset( $home_v4['swa']['ads_args'][2]['ad_text'] ) ? $home_v4['swa']['ads_args'][2]['ad_text'] : wp_kses_post( __( 'Tablets, Smartphones <strong>and more</strong>', 'electro' ) ),
    ...
    function electro_home_v4_products_carousel_tabs() {
        ...
        if ( is_woocommerce_activated() ) {
            ...
            $args = apply_filters( 'electro_home_v4_products_carousel_tabs_args', array(
                ...
                'carousel_args' => array(
                    'items'         => isset( $home_v4['pct']['product_columns'] ) ? intval( $home_v4['pct']['product_columns'] ) : 6,
