...
if ( ! class_exists( 'Electro_Options' ) ) {
	...
	class Electro_Options {
		...
		public function load_config() {
			...
			$options 		= array( 'general', 'shop', 'header', 'footer', 'mobile', 'navigation', 'blog', 'social', 'style', 'typography', 'custom-code' );
			...
			$sections 	= apply_filters( 'electro_options_sections_args', array( $general_options, $shop_options, $header_options, $footer_options, $mobile_options, $navigation_options, $blog_options, $social_options, $style_options, $typography_options, $custom_code_options ) );
			$theme 		= wp_get_theme();
			$args 		= array(
