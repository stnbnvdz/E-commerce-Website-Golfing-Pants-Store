			...
			<div id="slider_with_ads_block" class="panel electro_options_panel">
				...
				<?php
					...
					electro_wp_text_input( array( 
						...
						'value'			=> isset( $home_v4['swa']['ads_args'][0]['ad_text'] ) ? $home_v4['swa']['ads_args'][0]['ad_text'] : wp_kses_post( __( 'Catch Big <strong>Deals</strong> on the Cameras', 'electro' ) ),
					) );
				...
				<?php
					...
					electro_wp_text_input( array( 
						...
						'value'			=> isset( $home_v4['swa']['ads_args'][1]['ad_text'] ) ? $home_v4['swa']['ads_args'][1]['ad_text'] : wp_kses_post( __( 'Shop the <strong>Hottest</strong> Products', 'electro' ) ),
					) );
				...
				<?php
					...
					electro_wp_text_input( array( 
						...
						'value'			=> isset( $home_v4['swa']['ads_args'][2]['ad_text'] ) ? $home_v4['swa']['ads_args'][2]['ad_text'] : wp_kses_post( __( 'Tablets, Smartphones <strong>and more</strong>', 'electro' ) ),
					) );
