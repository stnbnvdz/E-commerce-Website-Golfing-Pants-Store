			...
			<div class="col-xs-12 col-sm-9 col-left">
				...
				<?php woocommerce_product_loop_start(); ?>
					...
					<?php
						...
						$add_to_cart_checkbox = '<div class="checkbox accessory-checkbox"><label><input checked disabled type="checkbox" class="product-check" data-price="'  . $display_price . '" data-price-suffix="'  . $price_suffix . '" data-product-id="' . electro_wc_get_product_id( $product ) . '" data-product-type="' . electro_wc_get_product_type( $product ) . '" /> <span class="product-title"><strong>' . esc_html__( 'This product: ', 'electro' ) . '</strong>' . get_the_title() . '</span> ' . $price_html . '</label></div>';
					?>
			...
			<div class="col-xs-12 col-sm-3 col-right">
				<?php if( $total_price > 0 ) : ?>
					<div class="total-price">
						<?php
							$total_price_suffix_html = ( $total_price_suffix ? ' <small class="woocommerce-price-suffix">' . wc_price( $total_price_suffix ) . '</small>' : '' );
