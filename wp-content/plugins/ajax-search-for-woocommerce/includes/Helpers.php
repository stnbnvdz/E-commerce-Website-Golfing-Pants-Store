...
class Helpers {
     ...
     * @return array
     */
    public static function get_all_products_ids()
    {
        global $wpdb;


        $sql = $wpdb->prepare("SELECT ID FROM $wpdb->posts WHERE  post_type = '%s' AND post_status = 'publish'", DGWT_WCAS_WOO_PRODUCT_POST_TYPE);
    ...
    public static function getSettingsProLabel($label, $type = 'header', $headerSubtitle = '')
    {
        ...
        switch ($type) {
            case 'header':
                ...
                $html .= '<div class="dgwt-wcas-row dgwt-wcas-pro-header"><span class="dgwt-wcas-pro-label">' . $label . '</span><span class="dgwt-wcas-pro-suffix">' . __('Pro', 'justified-gallery') . '</span></div>';
                break;
            case 'option-label':
                $html .= '<div class="dgwt-wcas-row dgwt-wcas-pro-field"><span class="dgwt-wcas-pro-label">' . $label . '</span><span class="dgwt-wcas-pro-suffix">' . __('Pro', 'justified-gallery') . '</span></div>';
                break;
        }
